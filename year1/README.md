...
| 360 minutes | [**9**](units/unit9) | JavaScript: Values, Operators, Variables, & Conditionals| In this unit students are introduced to **Values, Operators, Variables, and Conditional Statements** by making two games that ask the user to guess a certain word or number.|
